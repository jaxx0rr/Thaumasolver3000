	...
	function getAspects($id){
		...
		foreach ($aspectlist as $key => $value) {
			for ($z=1;$z<16;$z++){
				if ($value["item".$z] == $id) {
					if ($i > 0) $aspects .= " ";
					$aspects .= "<img src='icons_aspects/".$value["pic"]."' width='32' height='32' />".$value["item".$z."a"]." ";
					//$aspects .= $value["name"];
					$i++;
				}
			}
...
<div align="center">
	...
	<td style="text-align:center;" colspan="2">
		<image src="cooltext1256548316.png"/><br>
...
<?
	...
	foreach ($aspectlist as $key => $value) {
		...
		if ($value["item9"] > 0) echo '<image class="tooltip" title="'.$itemlist[$value["item9"]]["name"].' ('.$value["item9a"].')" style="float:left;" src="items/'.$itemlist[$value["item9"]]["pic"].'"/>';
		if ($value["item10"] > 0) echo '<image class="tooltip" title="'.$itemlist[$value["item10"]]["name"].' ('.$value["item10a"].')" style="float:left;" src="items/'.$itemlist[$value["item10"]]["pic"].'"/>';
		if ($value["item11"] > 0) echo '<image class="tooltip" title="'.$itemlist[$value["item11"]]["name"].' ('.$value["item11a"].')" style="float:left;" src="items/'.$itemlist[$value["item11"]]["pic"].'"/>';
		if ($value["item12"] > 0) echo '<image class="tooltip" title="'.$itemlist[$value["item12"]]["name"].' ('.$value["item12a"].')" style="float:left;" src="items/'.$itemlist[$value["item12"]]["pic"].'"/>';
		if ($value["item13"] > 0) echo '<image class="tooltip" title="'.$itemlist[$value["item13"]]["name"].' ('.$value["item13a"].')" style="float:left;" src="items/'.$itemlist[$value["item13"]]["pic"].'"/>';
		if ($value["item14"] > 0) echo '<image class="tooltip" title="'.$itemlist[$value["item14"]]["name"].' ('.$value["item14a"].')" style="float:left;" src="items/'.$itemlist[$value["item14"]]["pic"].'"/>';
		if ($value["item15"] > 0) echo '<image class="tooltip" title="'.$itemlist[$value["item15"]]["name"].' ('.$value["item15a"].')" style="float:left;" src="items/'.$itemlist[$value["item15"]]["pic"].'"/>';
		if ($value["item16"] > 0) echo '<image class="tooltip" title="'.$itemlist[$value["item16"]]["name"].' ('.$value["item16a"].')" style="float:left;" src="items/'.$itemlist[$value["item16"]]["pic"].'"/>';
		echo '</td></tr></table><hr>';
	}
?>	
</td>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-45276480-1']);
...
<input type="hidden" name="hosted_button_id" value="UC9N6J97U39CL">
